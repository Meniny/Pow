...
public extension PowAttributes {
    ...
    /** Describes the frame of the pow. It's limitations, width and offset from the anchor (top / bottom of the screen) */
    public struct PositionConstraints {
        ...
        public enum SafeArea {
            ...
            /** The pow shows outs. But can optionally be colored */
        ...
        /** Describes an edge constraint of the pow */
        public enum Edge {
        ...
        public enum KeyboardRelation {
            ...
            public struct Offset {
                ...
                /** Describes top keyboard offset to the pow's bottom */
                public var bottom: CGFloat
                
                /** Describes top screen offset to the pow's top, useful to prevent the pow from exceeding the screen top bounds */
            ...
            /** Bind the pow's bottom to the keyboard's top with an offset.
             Additionally, the top edge of the screen can have a resistance offset which the pow isn't able to cross.
             The resistance is mostly used when the device orientation changes and the pow's frame crosses the screen bounds.
             Current isn't supported with center pow position.*/
            case bind(offset: Offset)
            
            /** Entry is unbound to the keyboard. It's location doesn't change. */
            case unbind
            
            /** Returns true if the pow is bound to the keyboard */
        ...
        /** The pow can be bound to keyboard in case of appearence */
        public var keyboardRelation = KeyboardRelation.unbind
        
        /** The size of the pow */
        public var size: Size
        
        /** The maximum size of the pow */
