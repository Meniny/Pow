//
//  PowAttributes+Scroll.swift
//  Pow
//
//  Created by Elias Abel on 4/30/18.
//
...
extension PowAttributes {
    ...
    public enum Scroll {
        ...
        /** Describes the event when the user leaves the pow after rubber-banding it - How the pow behaves */
        public struct PullbackAnimation {
            ...
            /** The pow is jolted when it's pulled back into the original position */
