 ...
 */
public class PowButtonBarView: UIView {
    
    // MARK: Props
    private var buttons: [UIButton] = []
    
    private let buttonBarContent: PowProperty.ButtonBarContent
    private let spreadAxis: PPAxis
    private let oppositeAxis: PPAxis
    ...
    public init(with buttonBarContent: PowProperty.ButtonBarContent) {
    ...
    // MARK: Setup Buttons
    private func setButton(for content: PowProperty.ButtonContent, index: Int) {
        let button = UIButton()
        button.tag = index
        addEvents(to: button)
    ...
    // Style & Text
    private func set(button: UIButton, with content: PowProperty.ButtonContent) {
    ...
    private func setBackground(for button: UIButton, by content: PowProperty.ButtonContent, isHighlighted: Bool) {
        if isHighlighted {
