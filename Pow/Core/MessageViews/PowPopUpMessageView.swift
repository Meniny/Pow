...
public class PowPopUpMessageView: UIView {
    ...
    private let message: PowPopUpMessage
    
    // MARK: Setup
    public init(with message: PowPopUpMessage) {
    ...
    private func setupDescriptionLabel() {
        ...
        descriptionLabel.labelContent = message.description
